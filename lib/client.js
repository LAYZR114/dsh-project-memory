...
/* 搜索：照抄成熟做法（Codrops《Expanding Search Bar》思路 https://tympanus.net/codrops/2013/06/26/expanding-search-bar-deconstructed/ ）：
   ① 默认只显示**图标按钮**；② 点它，输入框**从图标处滑出**；③ 输入框是**绝对定位覆盖层**（overlay）——
      不参与 flex 布局，所以既不挤压筛选胶囊、也不产生左右滚动条；④ 宽度够宽（320px）看得清；
   ⑤ 再点图标（空词时）收起；⑥ 点外部也收起。 */
.pm-search{position:relative;flex:0 0 auto}
.pm-search-btn{display:inline-flex;align-items:center;justify-content:center;gap:6px;background:#1f1f1f;color:#b5b5b5;border:1px solid #2c2c2c;border-radius:20px;padding:5px 12px;cursor:pointer;height:30px;box-sizing:border-box;position:relative;z-index:2}
.pm-search-btn:hover{background:#262626}
.pm-search-btn.on{background:#3a3a3a;color:#f0f0f0;border-color:#3a3a3a}
.pm-search-box{position:absolute;left:0;top:0;z-index:3;display:inline-flex;align-items:center;gap:6px;background:#1a1a1a;border:1px solid #4a4a4a;border-radius:20px;padding:0 10px;height:30px;box-sizing:border-box;box-shadow:0 8px 24px rgba(0,0,0,.5);animation:pm-search-in .18s ease}
.pm-search-box input{width:300px;max-width:52vw;background:transparent;border:none;color:#e6e6e6;font-size:12px;outline:none;padding:0}
...
@keyframes pm-search-in{from{opacity:0;transform:scaleX(.85);transform-origin:left center}to{opacity:1;transform:scaleX(1)}}
		...
		function MemorySection() {
			...
			return h("div", { className: "pm" },
				...
				h("div", { className: "pm-bar" },
					...
					// 搜索（照抄 Codrops 的展开式搜索做法）：图标按钮常驻；点它 → 输入框**覆盖式滑出**（绝对定位，
					// 不挤压胶囊/排序、不产生横向滚动）；**空词时再点按钮收起**；点外部也收起。
					h("div", { key: "search", className: "pm-search" }, [
						...
						searchOpen ? h("div", { key: "box", className: "pm-search-box" }, [
							h("svg", {
								key: "lens2", width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor",
								"stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", style: { flex: "0 0 auto", color: "#8f8f8f" },
							}, [h("circle", { key: "c", cx: "11", cy: "11", r: "8" }), h("line", { key: "l", x1: "21", y1: "21", x2: "16.65", y2: "16.65" })]),
							h("input", {
