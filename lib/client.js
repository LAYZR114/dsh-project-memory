...
/* 输入框外壳：**禁止伸缩**（flex:0 0 auto）+ 固定宽度。
   之前写 flex:0 1 auto 仍会参与伸缩计算；为保证「输入框右侧不留空白」，这里彻底写死。
   展开搜索时改由 .pm-toolbar-search 缩到 150px（仍是固定值，不依赖 flex 计算）。 */
.pm-toolbar .pm-ac-wrap{flex:0 0 auto;width:240px}
