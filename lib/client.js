...
.pm-stat-recent{max-width:330px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
...
.pm-save{background:#3a3a3a;color:#f0f0f0;border:none;border-radius:10px;padding:8px 18px;font-size:13px;cursor:pointer;white-space:nowrap}
