...
.pm-search-btn{display:inline-flex;align-items:center;justify-content:center;gap:6px;background:#141414;color:#b5b5b5;border:1px solid #141414;border-radius:20px;padding:5px 12px;cursor:pointer;height:30px;box-sizing:border-box;position:relative;z-index:2;transition:background .15s ease,color .15s ease}
.pm-search-btn:hover{background:#1f1f1f;color:#e6e6e6}
.pm-search-btn.on{background:#141414;color:#8f8f8f;border-color:#141414;padding:5px 10px}
.pm-search-box{position:absolute;left:0;top:0;z-index:3;display:inline-flex;align-items:center;gap:4px;background:#141414;border:1px solid #141414;border-radius:20px;padding:0 10px 0 34px;height:30px;box-sizing:border-box;box-shadow:0 8px 24px rgba(0,0,0,.45);animation:pm-search-in .18s ease}
.pm-search-box input{width:200px;max-width:38vw;background:transparent;border:none;color:#e6e6e6;font-size:12px;outline:none;padding:0}
